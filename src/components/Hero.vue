...
.animated-name:hover {
    ...
    filter: drop-shadow(0 0 12px rgba(255, 123, 26, 0.45));
    cursor: pointer;
}
...
.social-link:hover {
    ...
    box-shadow: 0 8px 16px rgba(255, 123, 26, 0.35);
}
...
.profile-frame {
    ...
    padding: 10px;
    background: var(--gradient-1);
    box-shadow: 0 0 50px rgba(255, 123, 26, 0.35);
    z-index: 2;
...
.profile-frame:hover {
    ...
    box-shadow: 0 0 70px rgba(255, 123, 26, 0.6);
}
...
.card-2 { top: 50%; left: 0; animation-delay: 1s; }
.card-3 { bottom: 10%; right: 20%; animation-delay: 2s; }
